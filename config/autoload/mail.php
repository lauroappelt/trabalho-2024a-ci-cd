...
return [
    ...
    */
    ...
    'mailers' => [
        'smtp' => [
            ...
            'dsn' => env('031af8bc60a2f6:a4ef4d3873f6fb@sandbox.smtp.mailtrap.io:25'),
        ],
    ...
    */
    ...
    'from' => [
        'address' => env('MAIL_FROM_ADDRESS', 'eventosfull@example.com'),
        'name' => env('MAIL_FROM_NAME', 'EventosFull'),
    ],
